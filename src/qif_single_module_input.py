...
# @Last Modified: 2021-05-22 20:00:41
# ------------------------------------------------------------------------------ #
...
mini_g = PoissonInput(target=G_normal, target_var="IA", N=1, rate=rate, weight=gm)
...
stim_s = Synapses(
    stim_g, G[bridge_ids], on_pre="v_post = 2*vp", name="apply_stimulation",
)
